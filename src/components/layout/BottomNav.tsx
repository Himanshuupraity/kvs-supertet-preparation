...
export function BottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 inset-x-0 z-40 bg-white/95 backdrop-blur border-t border-surface-border pb-[max(var(--safe-bottom),0.75rem)] [touch-action:manipulation]" aria-label="Primary">
